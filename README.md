...
## 🧐 Processo de Criação
Utilizei o "Gamma" para preparar e realizar os slides do material sobre "O mercado de trabalho e a inteligência artificial". Fazemos uma conta (login) na plataforma e descrevemos o prompts com os comandos necessários para o e-book seguir a linha de raciocínio da proposta.
